...
export interface TextContent extends Document {
...
// TextContentSchema.virtual('intentsID').get(function() {
//   return this.intents
// })

TextContentSchema.virtual('intentsObject', {
  ref: 'Intent', // The model to use
  localField: 'intents', // Find people where `localField`
  foreignField: '_id', // is equal to `foreignField`
})

export const TextContentModel = model<TextContent>('TextContent', TextContentSchema)
